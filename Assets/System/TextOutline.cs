// 출처: https://bbangdeveloper.tistory.com/entry/TextMesh%EB%A1%9C-outline-Text-%ED%91%9C%EC%8B%9C
    ...
    public class TextOutline : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            for (var i = 0; i < transform.childCount; i++)
            {
                ...
                //pixelSize를 두배로 합니다.
                var doublePixel = resolutionDependant && (Screen.width > doubleResolution || Screen.height > doubleResolution);
